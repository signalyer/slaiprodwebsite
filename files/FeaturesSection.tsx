            ...
            return (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  {/* Icon */}
                  <div
                    className="w-10 h-10 rounded-xl flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110 self-start"
                    style={{ background: `${feature.accent}15`, border: `1.5px solid ${feature.accent}40` }}
                  >
                    <Icon className="w-5 h-5" style={{ color: feature.accent }} />
                  </div>
                  <h3
                    className="font-heading font-bold text-lg text-foreground mb-2.5 transition-colors duration-300"
                  ...
                  <span
                    className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wide transition-all duration-300 group-hover:gap-2.5"
